...
export const benefitData: benefitDataType = [
  {
    ...
    image: (
      <StaticImage
        src="../../static/images/details/NT.png"
        width={280}
        height={141}
        alt={""}
      />
  ...
  },
  {
    ...
    image: (
      <StaticImage
        src="../../static/images/details/message.png"
        width={280}
        height={141}
        alt={""}
      />
  ...
  },
  {
    ...
    image: (
      <StaticImage
        src="../../static/images/details/createInvoice.png"
        width={280}
        height={141}
        alt={""}
      />
...
export const slideData: slideDataType = [
  [
    ...
    },
    {
      image: (
        <StaticImage
          src="../../static/images/details/NTH.png"
          alt={""}
          loading={"eager"}
        />
      ),
  ...
  [
    ...
    },
    {
      image: (
        <StaticImage
          src="../../static/images/details/announcement.png"
          alt={""}
          loading={"eager"}
        />
      ),
  ...
  [
    {
      ...
      title: "請求書の作成",
      detail: `保護者向けの毎月の請求書を簡単に請求書の作成と管理を行うことが出来ます。
    ...
    },
    {
      image: (
        <StaticImage
          src="../../static/images/details/inMoneyManage.png"
          alt={""}
          loading={"eager"}
        />
      ),
...
export const questions: Array<QandA> = [
  ...
  },
  {
    ...
    answer:
      "ミルコマご利用ガイドをご覧いただき、それでも解決しない場合には、お問い合わせよりご連絡ください。!",
    detailLink: null,
  },
]
...
export const planButtonData: planButtonDataType = [
  {
    ...
    image: (
      <StaticImage
        src="../../static/images/joinPlanButtonLogo.png"
        alt={""}
        loading={"eager"}
      />
    ),
    priceText: "1,100 円／月 (税込)",
    chips: ["入退室機能", "入退室履歴", "スマホアプリ"],
  },
  {
    title: "メッセージ管理プラン",
    image: (
  ...
  },
  {
    ...
    image: (
      <StaticImage
        src="../../static/images/billPlanButtonLogo.png"
        alt={""}
        loading={"eager"}
      />
    ),
