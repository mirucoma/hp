...
const BUILDING_NAME_FIELD_ID = 'entry.752328732'
const CUSTOMER_NAME_FIELD_ID = 'entry.248400907'
const DATE_FIELD_ID = 'entry.1515737950'

const sendGoogleForm = () => {
  const email = getInputValue('email')
  const schoolName = getInputValue('schoolName')
  const buildingName = getInputValue('buildingName')
  ...
  formData.append(BUILDING_NAME_FIELD_ID, buildingName)
  formData.append(CUSTOMER_NAME_FIELD_ID, customerName)
  formData.append(DATE_FIELD_ID, date)

  fetch(
    "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfYGwBGeaoBnwpg9g64M7nVD5HbDvtL3abVbRlg24FHItTP3Q/formResponse",
    {
      method: "POST",
      body: formData,
    },
